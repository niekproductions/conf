...
MyApplet.prototype = {
    ...
    _devicesChanged: function() {
        ...
        this._proxy.GetDevicesRemote(Lang.bind(this, function(result, error) {
            ...
            if (false) {//this._primaryDevice != null) {
		// Only primary device when charging
		    ...
		    this.showDeviceInPanel(this._devices[0]);
        	    ...
        	    var pseudodevice = this._devices[0];
         	    for ( let i = 1; i < this._devices.length; ++i ) {
                    	// device_id, vendor, model, device_type, icon, percentage, state, seconds
			pseudodevice[5] += this._devices[i][5];
			pseudodevice[7] += this._devices[i][7];
		    }
                    this.showDeviceInPanel(pseudodevice);
                    // Show a summary
